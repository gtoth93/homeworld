...
static char *LSTRING_FINebulaRich[] = {  // multilingual strings
	...
	"La NTbuleuse est incroyablement riche en Tnergie et en ressources. Il y a de tels niveaux d'Tnergie que nos dTtecteurs peinent a compenser.\n\nCommencez la collecte dans la nTbuleuse pendant que nous nous penchons sur ce problFme.",
	"Der Nebel ist unglaublich reich an Energie und Rohstoffen. Die Energie-Level sind so hoch, dass unsere Sensoren Probleme haben, dies zu kompensieren.\n\nBeginnen Sie mit der Rohstoffernte im Nebel, wShrend wir uns um dieses Problem knmmern.",
	"La nebulosa es muy rica en energfa y recursos. Los niveles de energfa son tan altos que nuestros sensores no pueden compensarlos.\n\nEmpieza a recolectar en la nebulosa mientras buscamos soluci=n a este problema.",
	"Questa nebulosa F ricchissima di energia e risorse; i livelli energetici sono cos8 alti che i nostri sensori non riescono a calcolarli.\n\nComincia la raccolta delle risorse, mentre tentiamo di risolvere questo problema.", };
...
static char *LSTRING_FIUnknownContacts[] = {  // multilingual strings
	...
	"Contact Ttabli avec vThicule prFs du Vaisseau MFre, mais l'instabilitT des dTtecteurs dans cette rTgion rend son identification difficile.",
	"Ein Kontakt nShert sich dem Mutterschiff. Die Sensor-InstabilitSt in dieser Region macht eine Identifikation sehr schwierig.",
	"Se estß cerrando un contacto con la Nave nodriza. La inestabilidad de los sensores en esta zona dificulta la identificaci=n de ese contacto.",
	"C'F un contatto in avvicinamento all'Astronave Madre. Purtroppo, i sensori sono fuori scala e non riescono a identificarlo.", };

static char *LSTRING_FIPreparingAmbassador[] = {  // multilingual strings
	"Prepare the Ambassador.",
	"PrTparation de l'Ambassadeur.",
...
static char *LSTRING_FIDefendMothership[] = {  // multilingual strings
	...
	"Retardez les vaisseaux agresseurs pendant que l'AmirautT charge le module d'hyperpropulsion. La portTe devrait Otre suffisante pour nous faire bondir hors de la nTbuleuse.",
	"Halten Sie die angreifenden Schiffe zurnck, wShrend das Flottenkommando das Hypersprung-Modul auflSdt. Unsere Reichweite sollte so gro¯ sein, dass wir aus dem Nebel herausspringen.",
...
static char *LSTRING_FCHyperModuleCharging1[] = {  // multilingual strings
	...
	"Module hyperspatial a 35%, prOt dans 8 minutes.",
...
static char *LSTRING_FCHyperModuleCharging2[] = {  // multilingual strings
	...
	"Module hyperspatial a 90%, prOt dans 1 minute.",
...
static char *LSTRING_FCLetsGetOutOfHere[] = {  // multilingual strings
	...
	"M=dulo hiperespacial completamente cargado. Vßmonos de este sitio.",
...
static char *LSTRING_FIEngage[] = {  // multilingual strings
	...
	"Oui, le cap est dTterminT. Enclenchez l'hyperpropulsion!",
	"Ja, Koordinaten sind eingestellt. Hypersprung-Aggregat einschalten!",
	"Sf, coordenadas establecidas. Activar hiperpropulsi=n.",
...
static char *LSTRING_FCHyperdriveFail[] = {  // multilingual strings
	...
	"Le bond par hyperpropulsion a TchouT ! Il y a eu effondrement de l'amplitude quantique avant mOme que le vaisseau puisse atteindre l'hyperespace.  ",
	"Hyperraum-Sprung fehlgeschlagen! Die Quanten-Wellenform brach zusammen, bevor das Schiff in den Hyperraum eintreten konnte.",
	"Ha fallado la hiperpropulsi=n. La forma de onda cußntica ha colapsado antes de que la nave pudiera entrar en el hiperespacio.",
	"Salto nell'Iperspazio fallito! La forma d'onda Quantum F collassata prima che la nave potesse entrare nell'Iperspazio.", };
...
static char *LSTRING_FIContinueProtecting[] = {  // multilingual strings
	...
	"Analyse de la dTfaillance. Protection du Vaisseau MFre jusqu'a rTsolution du problFme.",
	"Fehlfunktion wird analysiert. Schntzen Sie weiterhin das Mutterschiff, bis das Problem gel÷st ist.",
...
static char *LSTRING_FINewResearch[] = {  // multilingual strings
	...
	"Jamais n'avons nous dv affronter autant de chasseurs. Notre Service de recherche a Ttabli la faisabilitT d'un nouveau type de Corvette adaptT au combat contre de multiples chasseurs.  Lancez cette recherche dFs que possible.",
	"Wir mussten uns noch nie so vielen JSgern gleichzeitig stellen. Unsere Forschungsabteilung hat festgestellt, dass sie einen neuen Korvettentyp entwickeln kann, der speziell fnr den Kampf gegen mehrere JSger ausgelegt ist. Beginnen Sie so schnell wie m÷glich mit den Forschungsarbeiten.",
	"Nunca habfamos tenido que enfrentarnos a tantos cazas juntos. Nuestra divisi=n de investigaci=n ha determinado que puede dise±ar un nuevo tipo de corbeta concebida especialmente para combatir a varios cazas. La investigaci=n debe comenzar cuanto antes.",
	"Non abbiamo mai dovuto combattere con cos8 tanti caccia prima d'ora. I nostri ricercatori pensano di poter creare un nuovo tipo di Corvetta, dedicata al combattimento contro nemici multipli. Comincia le ricerche il prima possibile.", };
...
static char *LSTRING_FIProtectResources[] = {  // multilingual strings
	...
	"Les forces ennemies se concentrent sur nos Collecteurs de Ressources.  Affectez des unitTs de combat a leur protection.",
	"Feindliche KrSfte konzentrieren sich auf unsere Rohstoffernteschiffe. Setzen Sie Kampfschiffe zu ihrem Schutz ein.",
...
static char *LSTRING_FCHyperspaceBack[] = {  // multilingual strings
	...
	"L'hyperpropulsion est de nouveau opTrationnelle.",
	"Das Hypersprung-Aggregat ist wieder online.",
	"Ya funciona la hiperpropulsi=n.",
	"L'Iperguida F di nuovo operativa.", };
...
static char *LSTRING_OBHarvestNebula[] = {  // multilingual strings
	"Harvest Nebula",
	"Collecter des ressources au sein de la NTbuleuse",
...
static char *LSTRING_OBProtect[] = {  // multilingual strings
	"Protect Resourcers",
	"ProtTger les collecteurs de ressources",
	"Rohstoffschiffe schntzen.",

...
static char *LSTRING_PrimaryObjective01[] = {  // multilingual strings
	...
	"DTmarrage collecte des ressources.",
...
static char *LSTRING_PrimaryObjective02[] = {  // multilingual strings
	...
	"Destruction totalitT des Vaisseaux du Maraudeur Turanique",
	"Alle Schiffe der turanischen Freibeuter sind zu zerst÷ren.",
	"Destruir todas las naves de asalto turßnicas",
...
static char *LSTRING_SecondaryObjective01[] = {  // multilingual strings
	...
	"Rohstoffnberwachungsschiff bauen und einsetzen.",
...
static char *LSTRING_FISetupCollection[] = {  // multilingual strings
	...
	"Mise en oeuvre opTration de collecte.",
...
static char *LSTRING_FIResourceControllerTip[] = {  // multilingual strings
	...
	"Approchez le plus possible votre Contr(leur des Ressources des gisements importants de ressources. Ceci rTduira la durTe de dTchargement pour le Collecteur de Ressources et amTliorera l'efficacitT de la collecte.",
	"Bringen Sie Ihr Rohstoffnberwachungsschiff so dicht wie m÷glich an ergiebige Rohstoffbereiche heran. Das verringert die Transportzeit der Rohstoffernteschiffe und erh÷ht die Effizienz der Rohstoffernte.",
...
static char *LSTRING_GoodBusiness[] = {  // multilingual strings
	...
	"Nous possTdons une avancTe technologique que nous serions prOts a vous vendre lorsque vous aurez rTuni assez de ressources.",
	"Wenn ihr genngend Rohstoffe gesammelt habt, haben wir eine Technologie, die wir euch verkaufen wnrden",
	"Cuando hayas recolectado suficientes recursos, tenemos cierta tecnologfa que estamos dispuestos a venderte.",
	"Quando avrai raccolto risorse sufficienti, vieni da noi: abbiamo qualcosa che crediamo ti potra tornare davvero utile.", };
...
static char *LSTRING_IonFrigs[] = {  // multilingual strings
	...
	"Plusieurs UnitTs lourdes du Maraudeur Turanique viennent de sortir de l'hyperespace prFs du Vaisseau MFre. C'est de loin la menace la plus sTrieuse qui se soit prTsentTe jusqu'a prTsent. PrioritT absolue : Protection du Vaisseau MFre.",
	"Mehrere Schlachtschiffe der turanischen Freibeuter sind gerade in der NShe des Mutterschiffs aus dem Hyperraum gekommen. Sie stellen mit Abstand die gr÷¯te Gefahr dar, der wir uns je gegennber sahen. Der Schutz des Mutterschiffs hat oberste PrioritSt.",
	"Varias Naves capital turßnicas de asalto acaban de salir del hiperespacio cerca de la Nave nodriza. Representan el mayor peligro al que nos hemos enfrentado. Nuestra prioridad es la de proteger a la Nave nodriza.",
	"Molte navi Incursori dei Turanic sono appena emerse dall'Iperspazio e si stanno dirigendo verso l'Astronave Madre. Siamo di fronte a una minaccia senza precedenti, F assolutamente necessario difendere l'Astronave Madre.", };
...
static char *LSTRING_FIGoGetThem[] = {  // multilingual strings
	...
	"TrSgerschiffe der zurnckweichenden turanischen Freibeuter zerst÷ren.",
	"Destruir el portanaves de asalto turßnico que se retira",
